...
trait NewMovieJson extends CoreJson {

  implicit val movieDecoder: Decoder[NewMovie] = Decoder.instance[NewMovie] { (c: HCursor) =>
    for {
    ...
    } yield NewMovie(name, ranking, releaseDate)
  }
